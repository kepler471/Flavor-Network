...
if __name__ == '__main__':
    ...
    cuisinedic = {'italian': 'Italian', 'mexican': 'Mexican', 'southern': 'Southern & Soul Food', 'french': 'French',
                  'southwestern': 'Southwestern', 'indian': 'Indian', 'cajun': 'Cajun & Creole', 'english': 'English',
                  'mediterranean': 'Mediterranean', 'greek': 'Greek', \
                  'spanish': 'Spanish', 'german': 'German', 'thai': 'Thai', 'moroccan': 'Moroccan', 'irish': 'Irish',
                  'japanese': 'Japanese', 'cuban': 'Cuban', 'swidish': 'Swidish', 'hungarian': 'Hungarain',
